...
0 20 * * * root /www/camera-filter/bin/preprocessor.py -f /www/camera-filter/conf/camera-filter.yml && /www/camera-filter/bin/classifier.py -f /www/camera-filter/conf/camera-filter.yml >> /www/camera-filter/log/classifier-"$(date +\%Y\%m\%d)".log
